...
var app = (function () {
    ...
    */
    ...
    /* src/Calendar.svelte generated by Svelte v3.31.2 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 32, 0, 726);
    		},
    ...
    class Calendar_1 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { events: 0 });
    ...
    // (90:1) {#each sleep as s}
    function create_each_block_2(ctx) {
    	let div;
    	let p0;
    	let t0_value = /*s*/ ctx[13][1] + "";
    	let t0;
    	let t1;
    	let p1;
    	let t2_value = /*s*/ ctx[13][2] + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(p0, file$1, 91, 3, 2137);
    			add_location(p1, file$1, 92, 3, 2154);
    			attr_dev(div, "class", "rows svelte-1uzhnvq");
    			add_location(div, file$1, 90, 2, 2115);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, p0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*sleep*/ 1 && t0_value !== (t0_value = /*s*/ ctx[13][1] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*sleep*/ 1 && t2_value !== (t2_value = /*s*/ ctx[13][2] + "")) set_data_dev(t2, t2_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    ...
    // (98:1) {#each wet_diapers as w}
    function create_each_block_1(ctx) {
    	let p;
    	let t_value = /*w*/ ctx[10][1] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$1, 98, 2, 2244);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*wet_diapers*/ 4 && t_value !== (t_value = /*w*/ ctx[10][1] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(98:1) {#each wet_diapers as w}",
    		ctx
    	});
    ...
    // (102:1) {#each poops as p}
    function create_each_block(ctx) {
    	let p;
    	let t_value = /*p*/ ctx[7][1] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			t = text(t_value);
    			add_location(p, file$1, 102, 2, 2305);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*poops*/ 2 && t_value !== (t_value = /*p*/ ctx[7][1] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_fragment$1(ctx) {
    	...
    	calendar = new Calendar_1({
    			props: { events: /*cal_events*/ ctx[3] },
    			$$inline: true
    		});

    	let each_value_2 = /*sleep*/ ctx[0];
    	...
    	let each_value_1 = /*wet_diapers*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Pi Baby";
    			t1 = space();
    			div0 = element("div");
    			create_component(calendar.$$.fragment);
    			t2 = space();
    			h20 = element("h2");
    			h20.textContent = "Sleep";
    			t4 = space();
    			div1 = element("div");
    			...
    			t11 = space();
    			div2 = element("div");
    			attr_dev(h1, "class", "svelte-1uzhnvq");
    			add_location(h1, file$1, 83, 1, 1978);
    			attr_dev(div0, "class", "card svelte-1uzhnvq");
    			add_location(div0, file$1, 84, 1, 1996);
    			attr_dev(h20, "class", "svelte-1uzhnvq");
    			add_location(h20, file$1, 87, 1, 2058);
    			attr_dev(div1, "class", "card svelte-1uzhnvq");
    			add_location(div1, file$1, 88, 1, 2074);
    			attr_dev(h21, "class", "svelte-1uzhnvq");
    			add_location(h21, file$1, 96, 1, 2195);
    			attr_dev(h22, "class", "svelte-1uzhnvq");
    			add_location(h22, file$1, 100, 1, 2268);
    			add_location(div2, file$1, 105, 1, 2331);
    			attr_dev(main, "class", "svelte-1uzhnvq");
    			add_location(main, file$1, 82, 0, 1970);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*cal_events*/ 8) calendar_changes.events = /*cal_events*/ ctx[3];
    			calendar.$set(calendar_changes);

    			if (dirty & /*sleep*/ 1) {
    				each_value_2 = /*sleep*/ ctx[0];
    				validate_each_argument(each_value_2);
    				let i;
    			...
    			if (dirty & /*wet_diapers*/ 4) {
    				each_value_1 = /*wet_diapers*/ ctx[2];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const initHandler = json => {
    		...
    		json.poops.forEach(p => {
    			place_holder.push({ title: "poop", start: p[1] });
    		});

    		json.wet_diaper.forEach(w => {
    			place_holder.push({ title: "wet diaper", start: w[1] });
    		});

    		$$invalidate(3, cal_events = place_holder);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("sleep" in $$props) $$invalidate(0, sleep = $$props.sleep);
    		if ("poops" in $$props) $$invalidate(1, poops = $$props.poops);
    		if ("wet_diapers" in $$props) $$invalidate(2, wet_diapers = $$props.wet_diapers);
    		if ("cal_events" in $$props) $$invalidate(3, cal_events = $$props.cal_events);
    	};
    	...
    	if ($$props && "$$inject" in $$props) {
    	 ...
    	 $$invalidate(0, sleep = []);
    	 $$invalidate(1, poops = []);
    	 $$invalidate(2, wet_diapers = []);
    	 $$invalidate(3, cal_events = []);
    	return [sleep, poops, wet_diapers, cal_events];
    }
